...
public class SnmpUtil extends Thread implements PDUFactory, CommandResponder {
	...
	public boolean InformReceived=false;
	public boolean snmp_test=false;
	...
	public void sendAndProcessResponse() {
		try {
			...
			if ((getPduType() == PDU.TRAP) ||
				...
				System.out.println("snmp not working or Request timed out.");
				snmp_test=false;
